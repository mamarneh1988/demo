...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(3292197293140710802)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292197600825710803)
,p_page_template_id=>wwv_flow_imp.id(3292197293140710802)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292197921054710803)
,p_page_template_id=>wwv_flow_imp.id(3292197293140710802)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292198196051710803)
,p_page_template_id=>wwv_flow_imp.id(3292197293140710802)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292198533582710803)
,p_page_template_id=>wwv_flow_imp.id(3292197293140710802)
,p_name=>'Body Footer'
