...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(3292207286980710809)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292207614431710809)
,p_page_template_id=>wwv_flow_imp.id(3292207286980710809)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292207859143710809)
,p_page_template_id=>wwv_flow_imp.id(3292207286980710809)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292208220920710810)
,p_page_template_id=>wwv_flow_imp.id(3292207286980710809)
