...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3292280931056710858)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292281167060710858)
,p_plug_template_id=>wwv_flow_imp.id(3292280931056710858)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292281495848710859)
,p_plug_template_id=>wwv_flow_imp.id(3292280931056710858)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292281799535710859)
,p_plug_template_id=>wwv_flow_imp.id(3292280931056710858)
,p_name=>'Button Start'
