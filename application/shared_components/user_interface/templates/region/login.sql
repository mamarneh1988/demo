...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3292283430554710860)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292283752600710860)
,p_plug_template_id=>wwv_flow_imp.id(3292283430554710860)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292284014105710860)
,p_plug_template_id=>wwv_flow_imp.id(3292283430554710860)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292284280669710860)
,p_plug_template_id=>wwv_flow_imp.id(3292283430554710860)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292284593840710860)
,p_plug_template_id=>wwv_flow_imp.id(3292283430554710860)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292284945041710860)
,p_plug_template_id=>wwv_flow_imp.id(3292283430554710860)
,p_name=>'Sub Regions'
