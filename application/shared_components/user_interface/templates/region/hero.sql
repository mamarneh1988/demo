...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3292255658597710844)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292255953717710844)
,p_plug_template_id=>wwv_flow_imp.id(3292255658597710844)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292256253314710844)
,p_plug_template_id=>wwv_flow_imp.id(3292255658597710844)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292256515497710845)
,p_plug_template_id=>wwv_flow_imp.id(3292255658597710844)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292256780921710845)
,p_plug_template_id=>wwv_flow_imp.id(3292255658597710844)
,p_name=>'Sub Regions'
