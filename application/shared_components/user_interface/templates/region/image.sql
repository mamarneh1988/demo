...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3292258798720710846)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292259130531710846)
,p_plug_template_id=>wwv_flow_imp.id(3292258798720710846)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292259415465710846)
,p_plug_template_id=>wwv_flow_imp.id(3292258798720710846)
,p_name=>'Sub Regions'
