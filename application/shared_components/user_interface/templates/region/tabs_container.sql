...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3292298429371710868)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292298741532710869)
,p_plug_template_id=>wwv_flow_imp.id(3292298429371710868)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292299016597710869)
,p_plug_template_id=>wwv_flow_imp.id(3292298429371710868)
,p_name=>'Tabs'
