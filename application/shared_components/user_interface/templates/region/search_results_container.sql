...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3292285873630710861)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292286165615710861)
,p_plug_template_id=>wwv_flow_imp.id(3292285873630710861)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292286539045710861)
,p_plug_template_id=>wwv_flow_imp.id(3292285873630710861)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292286826269710862)
,p_plug_template_id=>wwv_flow_imp.id(3292285873630710861)
,p_name=>'Sub Regions'
