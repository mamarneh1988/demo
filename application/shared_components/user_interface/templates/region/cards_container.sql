...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3292229738676710823)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292229991019710824)
,p_plug_template_id=>wwv_flow_imp.id(3292229738676710823)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292230286518710824)
,p_plug_template_id=>wwv_flow_imp.id(3292229738676710823)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3292230639589710824)
,p_plug_template_id=>wwv_flow_imp.id(3292229738676710823)
,p_name=>'Sub Regions'
