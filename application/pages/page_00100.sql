...
,p_last_upd_yyyymmddhh24miss=>'20230710154000'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3297561848464982139)
,p_plug_name=>'Basics Navigation'
...
,p_list_id=>wwv_flow_imp.id(3298574186206510074)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(3292344535789710898)
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4115363202928512070)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(834331145908655489)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(4115363202928512070)
,p_button_name=>'PREV'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(834331466234658105)
